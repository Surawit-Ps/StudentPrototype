	...
	work := []entity.Work{
		{
			...
			WorkUse:      0,
			WorkCount:    10,
			WorkTime:     time.Date(2025, 9, 25, 10, 40, 0, 0, loc),
		...
		},
		{
			...
			Place:        "อาคารกาญจนาภิเษก มทส", //14.873083, 102.026355
			Latitude:     14.873083,
			Longitude:    102.026355,
			WorkUse:      0,
			WorkCount:    5,
		...
		},
		{
			...
			WorkCount:    3,
			WorkTime:     time.Date(2025, 9, 25, 10, 50, 0, 0, loc),
			Photo:        "https://scontent.fnak3-1.fna.fbcdn.net/v/t39.30808-6/472688291_1122230669597925_8149635421376151461_n.png?_nc_cat=101&ccb=1-7&_nc_sid=cc71e4&_nc_ohc=O9gBD-Z4r70Q7kNvwH4M9Ui&_nc_oc=AdlQuCJ61ZqR46zYKZeFPk9AouT-ck9_URqECHF48VMOJtCYFbHaFO5ZXI7isC6RuWI&_nc_zt=23&_nc_ht=scontent.fnak3-1.fna&_nc_gid=DKxpCnqTbBaq9bzZ6GNyRA&oh=00_AfYAW9ow2fiYog5w-JWWDE0df_QDVa-IL10eLcTP4tZ79A&oe=68D983D6",
			WorkStatusID: 1,
			WorkTypeID:   1,
			Paid:         IntPtr(500),
			PosterID:     1,
		},
		{
			...
			WorkUse:      0,
			WorkCount:    4,
			WorkTime:     time.Date(2025, 9, 27, 10, 0, 0, 0, loc),
		...
		},
		{
			...
			WorkUse:      0,
			WorkCount:    4,
			WorkTime:     time.Date(2025, 9, 28, 10, 0, 0, 0, loc),
		...
		},
		{
			...
			WorkUse:      0,
			WorkCount:    10,
			WorkTime:     time.Date(2025, 9, 28, 10, 30, 0, 0, loc),
		...
		},
		{
			...
			WorkUse:      0,
			WorkCount:    20,
			WorkTime:     time.Date(2025, 9, 28, 10, 50, 0, 0, loc),
		...
		{
			Title:        "อาสาสมัครงานแข่งขันกีฬามหาวิทยาลัย",
			Description:  "ช่วยจัดเตรียมอุปกรณ์ ดูแลสนาม และประสานงานกับนักกีฬา",
			Place:        "อาคารกีฬาภิรมย์ มทส.",
			Latitude:     14.886602, //14.886602, 102.018523
			Longitude:    102.018523,
			WorkUse:      0,
			WorkCount:    6,
			WorkTime:     time.Date(2025, 9, 28, 11, 0, 0, 0, loc),
			Photo:        "https://beta.sut.ac.th/shc/wp-content/uploads/sites/24/2020/06/Slider7.jpg",
			WorkStatusID: 1,
			WorkTypeID:   2,
			Volunteer:    IntPtr(3),
			PosterID:     2,
		...
		},
		{
			...
			WorkUse:      0,
			WorkCount:    3,
			WorkTime:     time.Date(2025, 9, 27, 10, 50, 0, 0, loc),
