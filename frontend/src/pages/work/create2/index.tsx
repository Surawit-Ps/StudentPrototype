...
import Navbar from "../../../components/Navbar/Navbar"; // ✅ นำ Navbar มาใช้
...
const WorkCreate2 = () => {
  ...
  const posterId = parseInt(localStorage.getItem("user_id") || "0");
                ...
                <Row gutter={[16, 16]}>
                  ...
                  <Col span={12}>
                    <Form.Item
                      name="WorkStatusID"
                      label="สถานะงาน"
                      rules={[{ required: true, message: "กรุณากรอกสถานะงาน" }]}
                    >
                  ...
                  {workTypeID === 2 && (
                    <Col span={12}>
                      <Form.Item
                        ...
                        rules={[{ required: true, message: "กรุณากรอกชั่วโมงจิตอาสา" }]}
                      >
                        <InputNumber style={{ width: "100%" }} />
                      </Form.Item>
                    </Col>
                  ...
                  <Col span={24}>
                    <Form.Item
                      ...
                      rules={[{ required: true, message: "กรุณากรอกวันและเวลางาน" }]}
                    >
                      <DatePicker
                        showTime
                        style={{ width: "100%" }}
